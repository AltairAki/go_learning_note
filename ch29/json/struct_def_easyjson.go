...
func easyjson7c82d03DecodeLearnSrcCh29Json(in *jlexer.Lexer, out *JobInfo) {
...
func easyjson7c82d03EncodeLearnSrcCh29Json(out *jwriter.Writer, in JobInfo) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v JobInfo) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson7c82d03EncodeLearnSrcCh29Json(&w, v)
...
func (v *JobInfo) UnmarshalJSON(data []byte) error {
	...
	easyjson7c82d03DecodeLearnSrcCh29Json(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *JobInfo) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7c82d03DecodeLearnSrcCh29Json(l, v)
}
func easyjson7c82d03DecodeLearnSrcCh29Json1(in *jlexer.Lexer, out *Employee) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson7c82d03EncodeLearnSrcCh29Json1(out *jwriter.Writer, in Employee) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Employee) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson7c82d03EncodeLearnSrcCh29Json1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *Employee) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson7c82d03DecodeLearnSrcCh29Json1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Employee) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7c82d03DecodeLearnSrcCh29Json1(l, v)
}
func easyjson7c82d03DecodeLearnSrcCh29Json2(in *jlexer.Lexer, out *BasicInfo) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson7c82d03EncodeLearnSrcCh29Json2(out *jwriter.Writer, in BasicInfo) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v BasicInfo) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson7c82d03EncodeLearnSrcCh29Json2(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *BasicInfo) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson7c82d03DecodeLearnSrcCh29Json2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *BasicInfo) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7c82d03DecodeLearnSrcCh29Json2(l, v)
}
